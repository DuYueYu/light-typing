	...
	<div class="shop">
		<div v-show="list.length" class="list">
			<div class="list-control">
				<Input search enter-button="搜索" class='list-control-search'/>
				<Button to='/cart'>
					<Icon type="ios-cart-outline" />购物车
					<Badge :count="allCount"></Badge>
				</Button>
			...
			<div class="list-product">
				<ProductCard v-for="item in filteredAndOrderedList" 
					:info="item" 
