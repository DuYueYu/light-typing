	...
	<Layout class="layout">
		<Content class="layout-keyboard">
			...
			<div id="fourthrow" class="layout-keyboard-row">
				<Button id="key-16-left">shift</Button>
...
export default {
	...
	methods: {
		highlightAndType(e) {
			...
			const keys = document.getElementById('key-' + keyPressed);
